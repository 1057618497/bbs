...
<div align="center">
    ...
    <script type="text/javascript"charset="utf-8">
        ...
        function f3() {
            var text=document.getElementById("area");
            var content=editor.txt.html();
            document.form.action="topicSaveAction";
    ...
    <form name="form" action="edit" method="post" id="form">
        <table >
            <tr>
                <td colspan="2"><b>标题:</b>
                    <input type="text" name="title" id="title" style="width:1000px" value="${topic.title}"><br></td><br>
            </tr>
            <tr>
                <td><br><b>请选择帖子类型:</b><br><br><br><hr></td>
                <td >
                    <br><input type="radio" name="isRequire" <c:if test="${topic.require==0}">checked</c:if> value="0">交流
                    <input type="radio" name="isRequire" <c:if test="${topic.require==1}">checked</c:if> value="1">需求
                    设置需求积分奖励：<input type="text" id="points" name="points" value="${topic.points}"   onblur="f6()"><br><br><br><hr>
                </td>
            </tr>
            ...
            <tr>
                <td colspan="2">
                    <input type="hidden" id="area" rows="15" cols="30" name="html" value="${topic.content}">
